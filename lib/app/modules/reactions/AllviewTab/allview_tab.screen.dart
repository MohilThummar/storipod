...
import 'controllers/allview_tab.controller.dart';

class AllviewTabScreen extends GetView<AllviewTabController> {
  const AllviewTabScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(AllviewTabController());
    return Scaffold(
