...
class _PersonProfileScreenViewState extends State<PersonProfileScreenView>
  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: ColorPicker.whiteColor,
      appBar: AppBar(
      ...
      body: Column(
        ...
        children: [
          ...
          // GetBuilder<PersonProfileScreenController>(
          //   builder: (controller) =>
          //       Expanded(
          //     child: TabBarView(
          //       physics: NeverScrollableScrollPhysics(),
          ...
          Expanded(
            child: TabBarView(
              ...
              Expanded(child: Column(children: [Text("data2"),],)),
              Expanded(child: Column(children: [Text("data3"),],)),
