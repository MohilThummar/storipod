...
class FindnewstoryView extends GetView<FindnewstoryController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<FindnewstoryController>(builder: (context) {
        return commanPaddingWidget(
          child: GetBuilder<FindnewstoryController>(builder: (context) {
            return Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: PageView.builder(
                      controller: controller.pageGridController,
                      onPageChanged: (int page) {
                        controller.activePageGrid = page;
                      },
                    ...
                    children: List<Widget>.generate(
                        ...
                        (index) => Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  controller.pageGridController.animateToPage(index,
                                      duration:
                                ...
                                child: CircleAvatar(
                                  radius: 4.r,
                                  backgroundColor:
                                      controller.activePageGrid == index
                                          ? Colors.blueAccent
